...
namespace Assignment.Migrations
{
    ...
    [Migration("20240911093333_RemoveTuitionClassIdFromStudentCourses")]
    partial class RemoveTuitionClassIdFromStudentCourses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment.Data.Comment", b =>
                {
            ...
            modelBuilder.Entity("Assignment.Data.TeacherCourse", b =>
                {
            ...
            modelBuilder.Entity("Assignment.Data.TuitionClass", b =>
                {
                    b.Property<int>("TuitionClassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TuitionClassId"));
                    ...
                    b.HasKey("TuitionClassId");

                    b.HasIndex("CourseId")
                        .IsUnique();

                    b.ToTable("TuitionClasses");
                });
            ...
            modelBuilder.Entity("Assignment.Data.Comment", b =>
                {
                    b.HasOne("Assignment.Data.TuitionClass", "TuitionClass")
                        .WithMany("Comments")
                        .HasForeignKey("TuitionClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TuitionClass");
                });
            ...
            modelBuilder.Entity("Assignment.Data.StudentCourse", b =>
                {
                    ...
                    b.HasOne("Assignment.Data.TuitionClass", null)
                        .WithMany("StudentCourses")
                        .HasForeignKey("TuitionClassId");
            ...
            modelBuilder.Entity("Assignment.Data.TeacherCourse", b =>
                {
                    ...
                    b.HasOne("Assignment.Data.User", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("Assignment.Data.TuitionClass", b =>
                {
                    b.HasOne("Assignment.Data.Course", "Course")
                        .WithOne("TuitionClass")
                        .HasForeignKey("Assignment.Data.TuitionClass", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
